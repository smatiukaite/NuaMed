...
class FavoritesView: UIView {
    ...
    func initConstraints() {
        NSLayoutConstraint.activate([
            //Filter container
            categoryFilterLabel.topAnchor.constraint(equalTo: self.safeAreaLayoutGuide.topAnchor, constant: 16),
            categoryFilterLabel.leadingAnchor.constraint(equalTo: self.safeAreaLayoutGuide.leadingAnchor, constant: 16),
            categoryFilterLabel.trailingAnchor.constraint(equalTo: self.safeAreaLayoutGuide.trailingAnchor, constant: -16),
            
            safetyIndexFilterLabel.topAnchor.constraint(equalTo: categoryFilterLabel.bottomAnchor, constant: 30),
            safetyIndexFilterLabel.leadingAnchor.constraint(equalTo: self.safeAreaLayoutGuide.leadingAnchor, constant: 16),
...
//            searchContainer.heightAnchor.constraint(equalToConstant: 44),
            ...
            resultTextFieldLabel.topAnchor.constraint(equalTo: safetyIndexFilterLabel.bottomAnchor, constant: 25),
            ...
            //Products table
            productsTableView.topAnchor.constraint(equalTo: safetyIndexFilterLabel.bottomAnchor, constant: 16),
